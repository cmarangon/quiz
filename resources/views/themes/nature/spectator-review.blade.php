@php
    $letters = ['a', 'b', 'c', 'd'];
@endphp
<div class="qz-theme qz-theme--nature qz-spectator qz-review w-full" wire:key="spectator-review-nature-{{ $currentQuestion['question_id'] ?? '' }}">
    @include('themes.nature._deco')
