<div class="mx-auto max-w-4xl p-6">
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold dark:text-white">My Quizzes</h1>
    ...
    @if($quizzes->isEmpty())
        <div class="rounded-lg border border-neutral-200 p-8 text-center dark:border-neutral-700">
            <p class="text-neutral-500 dark:text-neutral-400">You have no quizzes yet. Create your first one!</p>
        </div>
    @else
        <div class="space-y-4">
                ...
                <div class="flex items-center justify-between rounded-lg border border-neutral-200 p-4 dark:border-neutral-700">
                    <div>
                        ...
                        <p class="text-sm text-neutral-500 dark:text-neutral-400">
                            {{ $quiz->categories_count }} {{ Str::plural('category', $quiz->categories_count) }}
                        </p>
                    </div>
