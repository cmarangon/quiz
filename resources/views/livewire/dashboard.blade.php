<div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
    ...
    <div>
        <div class="mb-3 flex items-center justify-between">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">My Quizzes</h2>
            <a href="{{ route('quizzes.create') }}" class="text-sm text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">+ New Quiz</a>
        </div>

        @if($quizzes->isEmpty())
            <div class="rounded-xl border border-neutral-200 p-6 text-center text-gray-500 dark:border-neutral-700 dark:text-gray-400">
                No quizzes yet. <a href="{{ route('quizzes.create') }}" class="text-indigo-600 hover:underline dark:text-indigo-400">Create your first quiz</a>
            </div>
        @else
                ...
                <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                    <thead class="bg-gray-50 dark:bg-neutral-800">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Categories</th>
                        ...
                        @foreach($quizzes as $quiz)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-right text-sm">
                                    <a href="{{ route('quizzes.edit', $quiz) }}" class="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">Edit</a>
                                    <form action="{{ route('game.create', $quiz) }}" method="POST" class="ml-3 inline">
                                        @csrf
                                        <button type="submit" class="rounded bg-green-600 px-3 py-1 text-xs font-medium text-white hover:bg-green-500">Play</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
    ...
    {{-- Hosted Games --}}
    <div>
        <h2 class="mb-3 text-lg font-semibold text-gray-900 dark:text-gray-100">Hosted Games</h2>
        ...
        @else
            <div class="overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700">
                <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                    <thead class="bg-gray-50 dark:bg-neutral-800">
                        <tr>
                            <th class="px-4 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Quiz</th>
                            <th class="px-4 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Players</th>
                    ...
                    <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                        @foreach($hostedSessions as $session)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">{{ $session->players_count }} players</td>
    ...
    {{-- My Game History --}}
    <div>
        <h2 class="mb-3 text-lg font-semibold text-gray-900 dark:text-gray-100">My Game History</h2>
            ...
            <div class="overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700">
                <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                    <thead class="bg-gray-50 dark:bg-neutral-800">
                        <tr>
                            <th class="px-4 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Quiz</th>
                            <th class="px-4 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Score</th>
                            <th class="px-4 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Date</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
